...
/* Problemas al Crear la Tabla */Alter Table Bodega ADD Constraint fk_bodega_dueño FOREIGN KEY (Clave_dueño) references Bodega (Clave) ON DELETE CASCADE;
/* Problemas al Crear la Tabla */Alter Table Bodega ADD Constraint fk_bodega_pais_productor FOREIGN KEY (Clave_pais_productor) references Pais_productor (Clave) ON DELETE CASCADE;

/* Problemas al Crear la Tabla */Alter Table Marca ADD Constraint fk_marca_bodega FOREIGN KEY (Clave_bodega) references Bodega (Clave) ON DELETE CASCADE;
...
/* Problemas al Crear la Tabla */Alter Table Catador_experto ADD Constraint fk_catador_experto_pais_productor FOREIGN KEY (Clave_pais_productor) references Pais_productor (Clave) ON DELETE CASCADE;

/* Problemas al Crear la Tabla */Alter Table Catador_aprendiz ADD Constraint fk_catador_aprendiz_pais_productor FOREIGN KEY (Clave_pais_productor) references Pais_productor (Clave) ON DELETE CASCADE;
...
/* Problemas al Crear la Tabla */Alter Table Jueces ADD Constraint fk_jueces_catador_experto FOREIGN KEY (Clave_catador_experto) references Catador_experto (Clave) ON DELETE CASCADE;
...
/* Problemas al Crear la Tabla */Alter Table Cata_valor_aprendiz ADD Constraint fk_cata_valor_aprendiz_inscripcion FOREIGN KEY (Clave_inscripcion) references Inscripcion (Clave) ON DELETE CASCADE;
/* Problemas al Crear la Tabla */Alter Table Cata_valor_aprendiz ADD Constraint fk_cata_valor_aprendiz_muestra_catador FOREIGN KEY (Clave_muestra_catador) references Muestra_catador (Clave) ON DELETE CASCADE;

/* Problemas al Crear la Tabla */Alter Table Inscripcion ADD Constraint fk_inscripcion_bodega FOREIGN KEY (Clave_bodega) references Bodega (Clave) ON DELETE CASCADE;
/* Problemas al Crear la Tabla */Alter Table Inscripcion ADD Constraint fk_inscripcion_catador_aprendiz FOREIGN KEY (Clave_catador_aprendiz) references Catador_aprendiz (Clave) ON DELETE CASCADE;
...
/* Problemas al Crear la Tabla */Alter Table Vinedo ADD Constraint fk_vinedo_bodega FOREIGN KEY (Clave_bodega) references Bodega (Clave) ON DELETE CASCADE;
Alter Table Vinedo ADD Constraint fk_vinedo_denom_origen FOREIGN KEY (Clave_denominacion_origen) references Denominacion_origen (Clave) ON DELETE CASCADE;
...
/* Problemas al Crear la Tabla */Alter Table Catador_aprendiz ADD Constraint ck_catador_aprendiz_genero CHECK (Genero in('Masculino', 'Femenino'));
/* Problemas al Crear la Tabla */Alter Table Catador_experto ADD Constraint ck_catador_experto_genero CHECK (Genero in('Masculino', 'Femenino'));

Alter Table Cosecha ADD Constraint ck_cosecha_clasificacion CHECK (Clasificacion in('E', 'MB', 'B', 'R', 'O'));

/* Problemas al Definir opciones en el check */Alter Table Clasificacion ADD Constraint ck_clasificacion_nivel CHECK (Nivel in());
