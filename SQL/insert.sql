Insert into Pais_productor values (
    ...
    Exportacionanual_pais_nt(Distribucion_exp(Tipo_valor('01-01-2015', 1216),'Holanda'),Distribucion_exp(Tipo_valor('01-01-2016', 1100), 'Holanda'),Distribucion_exp(Tipo_valor('01-01-2017', 525),'Holanda'),Distribucion_exp(Tipo_valor('01-01-2015', 1400),'Mexico'),Distribucion_exp(Tipo_valor('01-01-2016', 1010),'Mexico'),Distribucion_exp(Tipo_valor('01-01-2017', 1100),'Mexico'),Distribucion_exp(Tipo_valor('01-01-2015', 1040),'Hungria'),Distribucion_exp(Tipo_valor('01-01-2016', 1005),'Hungria'),Distribucion_exp(Tipo_valor('01-01-2017', 1000),'Hungria')),
...
Insert into Pais_productor values (
    ...
    Exportacionanual_pais_nt(Distribucion_exp(Tipo_valor('01-01-2015', 7000),'Uruguay'),Distribucion_exp(Tipo_valor('01-01-2016', 6032), 'Uruguay'),Distribucion_exp(Tipo_valor('01-01-2017', 5200),'Uruguay'),Distribucion_exp(Tipo_valor('01-01-2015', 3006),'Japon'),Distribucion_exp(Tipo_valor('01-01-2016', 6500),'Japon'),Distribucion_exp(Tipo_valor('01-01-2017', 5107),'Japon'),Distribucion_exp(Tipo_valor('01-01-2015', 5000),'Mexico'),Distribucion_exp(Tipo_valor('01-01-2016', 2000),'Mexico'),Distribucion_exp(Tipo_valor('01-01-2017', 4000),'Mexico')),
...
Insert into Pais_productor values (
    ...
    Exportacionanual_pais_nt(Distribucion_exp(Tipo_valor('01-01-2015', 3000),'Japon'),Distribucion_exp(Tipo_valor('01-01-2016', 3000), 'Japon'),Distribucion_exp(Tipo_valor('01-01-2017', 3000),'Japon'),Distribucion_exp(Tipo_valor('01-01-2015', 2000),'Uruguay'),Distribucion_exp(Tipo_valor('01-01-2016', 2010),'Uruguay'),Distribucion_exp(Tipo_valor('01-01-2017', 2114),'Uruguay'),Distribucion_exp(Tipo_valor('01-01-2015', 2000),'Hungria'),Distribucion_exp(Tipo_valor('01-01-2016', 2100),'Hungria'),Distribucion_exp(Tipo_valor('01-01-2017', 2100),'Hungria')),
...
Insert into Pais_productor values (
    ...
    Produccionanual_pais_nt(Tipo_valor('01-01-2015', 11778),Tipo_valor('01-01-2016', 14984),Tipo_valor('01-01-2017', 15197)),
    Exportacionanual_pais_nt(Distribucion_exp(Tipo_valor('01-01-2015', 8076),'Holanda'),Distribucion_exp(Tipo_valor('01-01-2016', 6030), 'Holanda'),Distribucion_exp(Tipo_valor('01-01-2017', 7020),'Holanda'),Distribucion_exp(Tipo_valor('01-01-2015', 4300),'Uruguay'),Distribucion_exp(Tipo_valor('01-01-2016', 6037),'Uruguay'),Distribucion_exp(Tipo_valor('01-01-2017', 6500),'Uruguay'),Distribucion_exp(Tipo_valor('01-01-2015', 8600),'Japon'),Distribucion_exp(Tipo_valor('01-01-2016', 6300),'Japon'),Distribucion_exp(Tipo_valor('01-01-2017', 7200),'Japon')),
    Unidadmonetaria('Euro','€'),
    'Europa',
    empty_blob(),
...
Insert into Bodega values (
    ...
    Distribucion_exp_bodega_nt(Distribucion_exp(Tipo_valor('01-01-2015', 3300),NULL),Distribucion_exp(Tipo_valor('01-01-2016', 3500), NULL),Distribucion_exp(Tipo_valor('01-01-2017', 3900),NULL)),
    NULL,
    1 
); 
...
Insert into Bodega values (
    ...
    Distribucion_exp_bodega_nt(Distribucion_exp(Tipo_valor('01-01-2015', 300),NULL),Distribucion_exp(Tipo_valor('01-01-2016', 450), NULL),Distribucion_exp(Tipo_valor('01-01-2017', 540),NULL)),
    NULL,
    1 
); 
...
Insert into Bodega values (
    ...
    Distribucion_exp_bodega_nt(Distribucion_exp(Tipo_valor('01-01-2015', 800),NULL),Distribucion_exp(Tipo_valor('01-01-2016', 950), NULL),Distribucion_exp(Tipo_valor('01-01-2017', 1200),NULL)),
    NULL,
    3 
);
